...
Note: Technically, there is also the step of setting up Raspberry Pi OS and server, but since the use of RaPi is a personal preference and pretty straightforward anyway I do not include it.
